...
export class PoolToken extends ethereum.SmartContract {
  ...
  recipientWhitelistEnabled(): boolean {
    let result = super.call(
      ...
      "recipientWhitelistEnabled():(bool)",
      []
    );
  ...
  try_recipientWhitelistEnabled(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "recipientWhitelistEnabled",
      "recipientWhitelistEnabled():(bool)",
      []
  ...
  recipientWhitelisted(_recipient: Address): boolean {
    let result = super.call(
      ...
      "recipientWhitelisted(address):(bool)",
  ...
  try_recipientWhitelisted(_recipient: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "recipientWhitelisted",
      "recipientWhitelisted(address):(bool)",
      [ethereum.Value.fromAddress(_recipient)]
...
export class PoolMintCall extends ethereum.Call {
...
export class PoolRedeemCall extends ethereum.Call {
...
export class SetRecipientWhitelistEnabledCall extends ethereum.Call {
...
export class SetRecipientWhitelistedCall extends ethereum.Call {
